                ...
                >
                  <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                    <div className="flex items-center justify-between px-4">
                      <h2 className="text-lg font-medium text-lightGold">
                        Filters
                      </h2>
                      <button
                        type="button"
                            ...
                            <>
                              <h3 className="-mx-2 -my-3 flow-root">
                                <Disclosure.Button className="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500">
                                  <span className="font-medium text-lightGold">
                                    {section.name}
                                  </span>
            ...
            <div className="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
              ...
              <div className="flex items-center">
                <Menu as="div" className="relative inline-block text-left">
                  <div>
                    <Menu.Button className="group inline-flex justify-center text-sm font-medium text-lightGold text-opacity-70 hover:text-lightGold">
                      Sort
                      <ChevronDownIcon
            ...
            <section aria-labelledby="products-heading" className="pt-6 pb-24">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <form className="hidden lg:block">
                  ...
                  <ul
                    role="list"
                    className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-200"
                  >
                    {subCategories.map((category) => (
                      <li key={category.name}>
                      ...
                      {({ open }) => (
                        <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-lightGold opacity-80 py-3 text-sm text-gray-400 hover:text-gray-500">
                              ...
                              {section.options.map((option, optionIdx) => (
                                ...
                                >
                                  ...
                                  <label
                                    ...
                                    className="ml-3 text-sm text-lightGold opacity-60"
                                  >
                                    {option.label}
                                  </label>
                                </div>
