  ...
  return (
    <div className="about-container container mx-auto mt-10 px-5">
      <div className="bg-transparent section">
        ...
        <div className="pic">
          <img
            src="https://sokebeauty.com/wp-content/uploads/about.jpg"
            alt="pic"
          />
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="pic">
          <img
            src="https://sokebeauty.com/wp-content/uploads/Product-Page_5.jpg"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="pic">
          <img
            src="https://sokebeauty.com/wp-content/uploads/about-amy-new.jpg"
            alt=""
          />
        </div>
      </div>
      <div className="section">
        ...
        <div className="info">
          <div>
            <p>
              At the time I didn’t know it was going to be what it is today. I
              just knew it had to be simple, comfortable to wear, and actually
              work.
            </p>
            <p>
              After going down a rabbit hole of research and talking to half a
              dozen people I finally found something that would work.
            </p>
            <p>
              We took the most innovative medical-grade ingredients (currently
      ...
      <div className="section">
        <div className="info">
          <div>
            <p>
              Everyone can use Soke, no matter your skin type, age or lifestyle.
              I believe it is never too early or too late to invest in your
              skin. Use it any time and anywhere, whether you are busy working
              behind a screen, chasing your kids around, or simply enjoying
              life.
            </p>
            <p>
              <strong>
                Soke blends modern with effective in a way no other skincare
                does. It truly is the solution that I, and I believe the rest of
        ...
        <div className="pic">
          <img
            src="https://sokebeauty.com/wp-content/uploads/julie-optimized.gif"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="demo">
        <div className="pic">
          <img
            src="https://i.vimeocdn.com/video/1285630522-f222785de61046b033cb6c803ca3ff6fd39cb542e116d652d?mw=300&mh=375"
            alt=""
          />
        </div>
        <div className="pic">
      ...
      <div className="subscribe">
        ...
        <div className="sub">
          <p>Subscribe</p>
          <p>
            Receive 10% off your first purchase by signing up for updates about
